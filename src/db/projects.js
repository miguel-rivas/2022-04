...
const pj = [
  ...
  new Project(
    ...
    new Preview("drlogic"),
    [
      new LinkWeb("matryoshka/drlogic-home.html", "Home"),
      new LinkWeb("matryoshka/drlogic-team.html", "About Us"),
      new LinkWeb("matryoshka/drlogic-contact.html", "Contact Us"),
      new LinkWeb("matryoshka/drlogic-testimonials.html", "Testimonials"),
      new LinkWeb("matryoshka/drlogic-services.html", "Services"),
      new LinkWeb("matryoshka/drlogic-support.html", "Support"),
      new LinkWeb("matryoshka/drlogic-404.html", "404"),
    ],
    [
